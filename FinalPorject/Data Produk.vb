...
Public Class Produk
    ...
    Private Sub Produk_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'Db_pemdeskDataSet1.tblkategori' table. You can move, or remove it, as needed.
        Me.TblkategoriTableAdapter.Fill(Me.Db_pemdeskDataSet1.tblkategori)
